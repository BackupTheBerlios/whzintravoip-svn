...
public class Server_SIPPacketCaller implements SipListener {
    ...
    private static Server_SIPPacketCaller listenerCaller;
...
//    public static final String m_sMyAddress = "127.0.0.1";
    ...
    public Server_SIPPacketCaller() {
    }

    public Server_SIPPacketCaller(String to)
    {
        this.to = to;
    }
