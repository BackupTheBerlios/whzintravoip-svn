...
public class SOAPMethodCaller {
     ...
     */
    public SOAPMethodCaller(ThinClient gui, String serverURL, String serverURN,
                            String classToMap) {
     ...
     * @throws Exception -
     */
    public String registerMyselfAtServer(String methodToCall, User param1,
     ...
     * @throws Exception -
     */
    public String callSOAPServer(String methodToCall, String param1,
                                 String param2) throws Exception {
        URL url = new URL(m_sServerURL);
        Call call = new Call(); // prepare the service invocation
        call.setTargetObjectURI(m_sServerURN);
